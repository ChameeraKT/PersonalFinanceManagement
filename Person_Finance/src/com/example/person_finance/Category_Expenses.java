...
public class Category_Expenses extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_category__expenses);
		 ...
		 add.setOnClickListener(
				 new OnClickListener() {
					...
					public void onClick(View v) {
						...
						db.AddCat(catname,"Expenses");				//call the method to add category
						Toast.makeText(Category_Expenses.this, "Category Added", Toast.LENGTH_LONG).show();
						DisplayCat("Expenses");
						et.setText("");
						}
					}
		...
		//if the user select delete option
		 if(menuitemName=="Delete"){
			...
			//create an alert box ask for deletion
				AlertDialog.Builder builder = new AlertDialog.Builder(Category_Expenses.this);
				...
				builder.setPositiveButton("Yes",new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						Toast.makeText(Category_Expenses.this,"1 Item Deleted", Toast.LENGTH_LONG).show();
						DisplayCat("Expenses");
		...
		dialogBuilder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(et.getText().toString().matches(""))		//check whether textfield is empty or not
					Toast.makeText(Category_Expenses.this,"Cannot Update. Category name cannot be empty", Toast.LENGTH_LONG).show();
				if(!et.getText().toString().matches(regex))
				{
					et.setError("Type a Valid category");	
				}
				else{				
				String catEdit = et.getText().toString();
				db.UpdateCat(category,catEdit);			//update the category
				DisplayCat("Expenses");
				Toast.makeText(Category_Expenses.this,"Successfully Updated", Toast.LENGTH_LONG).show();
				}
			}
		}
		);
